...
/**
 * Utilities for registering all standard components with a runtime.
 */
object ComponentRegistrar {
    /**
     * Register all standard components to a reloadable runtime.
     */
    fun registerAll(runtime: ReloadableRuntime) {
     ...
     */
    fun registerAll(runtime: MoonstoneRuntime) {
        // Register layout components
        runtime.registerComponent(BoxComponent())
        runtime.registerComponent(ColumnComponent())
        runtime.registerComponent(RowComponent())
