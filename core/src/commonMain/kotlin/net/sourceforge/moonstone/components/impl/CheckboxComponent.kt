...
/**
 * Checkbox component with optional label children.
 *
 * Scheme usage:
 * (checkbox #:checked agree-state #:on-change (lambda (v) (state-set! agree-state v)))
 * (checkbox #:checked agree-state #:on-change handler (text #:value "I agree"))
 */
