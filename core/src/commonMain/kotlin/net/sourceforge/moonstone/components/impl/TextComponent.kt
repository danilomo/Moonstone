...
import net.sourceforge.moonstone.runtime.ValueResolver
...
class TextComponent : ComponentFactory {
    ...
    @Composable
    private fun parseTextStyle(value: Any?): TextStyle? = when (value) {
    ...
    private fun parseColor(value: Any?): Color? = when (value) {
        "red" -> Color.Red
        "green" -> Color.Green
        "blue" -> Color.Blue
        "white" -> Color.White
    ...
    private fun parseFontWeight(value: Any?): FontWeight? = when (value) {
